...
public class CalcPanel extends JPanel implements ActionListener {
	...
	JButton bdec, bclear, bequals;
	JButton bplus, bminus, btimes;
	...
	public CalcPanel()
	{
		...
		btimes.setBounds(154,100,50,50);
	...
	public void actionPerformed(ActionEvent e){
		...
		{
			if(usingFirst) {num1 += s;	display.setText(num1);}
			else {num2 += s; display.setText(num2);}
		}
		if(s.equals("+")) {	usingFirst = false; operator = "+";}
		if(s.equals("-")) {	usingFirst = false;	operator = "-";}
		if(s.equals("*")) {	usingFirst = false;	operator = "*";}
		if(s.equals("=")) {
			switch(operator){
